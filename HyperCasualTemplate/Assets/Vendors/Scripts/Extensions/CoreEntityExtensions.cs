...
namespace Krem.AppCore.Extensions
{
    ...
    {
        public static bool HasCoreComponent<T>(this CoreEntity instance) where T : CoreComponent
        {
            return instance.gameObject.GetComponent<T>() != null;
        }
        
        [CanBeNull]
        public static T GetCoreComponent<T>(this CoreEntity instance) where T : CoreComponent
        {
