...
namespace Krem.AppCore.EntityGraph.Views
{
    public class NodeView : Node
    {
        ...
        private void CreateInputComponentPortViews()
        {
            ...
            {
                Port inputPort = CreatePort(input, Orientation.Horizontal, Direction.Input, input.FieldType.GenericTypeArguments[0]);
        ...
        private void CreateOutputComponentPortViews()
        {
            ...
            Port outputPort = CreatePort(output, Orientation.Horizontal, Direction.Output, CoreNodeInstance.GetType());
        ...
        private void CreateInputSignalPortViews()
        {
            ...
            inputs.ForEach(input =>
            {
                Port inputPort = CreatePort(input, Orientation.Horizontal, Direction.Input, typeof(InputSignal));
        ...
        private void CreateOutputSignalPortViews()
        {
            ...
            {
                Port outputPort = CreatePort(output, Orientation.Horizontal, Direction.Output, typeof(OutputSignal));
        ...
        private void CreateOutputDataPortViews()
        {
            ...
            outputs.ForEach(output =>
            {
                Port outputPort = CreatePort(output, Orientation.Horizontal, Direction.Output,
                    output.FieldType.GenericTypeArguments[0]);
        ...
        private Port CreatePort(FieldInfo portField, Orientation orientation, Direction direction, Type portType)
        {
            CorePort corePort = CoreNodeInstance.ConvertFieldInfoToPort(portField) as CorePort;
            Port graphPort = InstantiatePort(orientation, direction, corePort.PortCapacity, portType);
